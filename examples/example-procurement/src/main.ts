/**
 * SDK-integrated Procurement Platform
 * This demonstrates @fhevm/sdk usage in a Vite + TypeScript app
 */
...
// ===== Wallet Connection with FHEVM SDK =====
async function connectWallet() {
  try {
    ...
    updateWalletStatus();
    showToast('Wallet connected & FHEVM SDK ready!', 'success');
  } catch (error: any) {
